...
/**
  ...
  *
  * Sea \e T un árbol sobre el tipo \e Tbase:
  *     - si \e T es vacío, entonces T.laraiz=0, y si no: T.laraiz.padre =0
  *     - para todo \e nodo de \e T, nodo->izquierda != nodo->derecha
  *		  - para todo nodo \e n y \e m si n->izquierda=m entonces m->padre=n
  
  * @section faConjunto Función de abstracción
  *
  * Sea T un árbol general sobre el tipo Tbase, si lo denotamos Arbol(T.laraiz),
  * es decir, como el árbol que cuelga de su raíz, entonces éste árbol del conjunto
  * de valores en la representación se aplica al árbol
  *
  *  {T.laraiz->etiqueta,{Arbol(T.laraiz->izda)},{Arbol(izda->dcha1)}...{Arbol(dcha_n-1 -> dcha_n)}}
  */
  ...
  private:
    ...
    /**
      ...
      *
      * La forma de implementarlo será asumiendo que se ha leido la primera marca, es decir,
      * que lo primero que se leerá será el dato que tendrá el primer nodo.
      *
      * @see escribe_arbol
      */
  ...
  public:
    ...
    /**
      ...
      */
    Nodo raiz() const{return this->laraiz;};
    ...
    /**
      ...
      * La operación se realiza en tiempo O(1).
      */
    Nodo hijomasizquierda(const Nodo n) const{return n->izquierda;};
    ...
    /**
      ...
      * La operación se realiza en tiempo O(1).
      */
    Nodo hermanoderecha(const Nodo n) const{return n->derecha;};
    ...
    /**
      ...
      * La operación se realiza en tiempo O(1).
      */
    Nodo padre(const Nodo n) const{return n->padre;}
    ...
    /**
      ...
      * La operación se realiza en tiempo O(1).
      */
    Tbase& etiqueta(const Nodo n){return n->etiqueta;}
    ...
    /**
      ...
      * La operación se realiza en tiempo O(1).
      */
    const Tbase& etiqueta(const Nodo n) const{return n->etiqueta;}
    ...
    /**
      ...
      * está vacío. La operación se realiza en tiempo O(n), donde \e n es el 
      * número de elementos del árbol receptor.
      */
    void clear(){destruir(this->laraiz);delete this->laraiz;}
    ...
    /**
      ...
      * @see contar
      */
    int size() const{return contar(this->laraiz);}
    ...
    /**
      ...
      * La operación se realiza en tiempo O(1).
      */
    bool empty() const{return laraiz == 0;}
    ...
    /**
      ...
      * La operación se realiza en tiempo O(n).
      */
    bool operator != (const ArbolGeneral<Tbase>& v) const{return !(*this == v);};
     ...
     * */
     ...
     /**
     * @brief Operador de asignación de iterador constante
     * @param i: iterador a asignar
     **/
